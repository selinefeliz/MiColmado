...
namespace MiColmado
{
    public partial class frmCategoria : SampleAdd 
    {
        private object MessageBoxButtonsl;
        ...
        private void loadData()
        {
            ...
            string qry = @"Select userID as ID, UuserName as NombreUsuario, uPass as Contraseña, uName as Nombre, uPhone as Telefono from users";
            //   where uName like '%" + txtSearch.Text + " %' order by userID desc";
        ...
        private void dataGridView1_CellClick_1(object sender, DataGridViewCellEventArgs e)
        {
            ...
            // Delete
            if (MessageBoxButtonsl.OwningColumn.Name == "dgvDe1")
            {
                //confirmar antes de borrar 
                MessageBoxButtons.OK, MessageBoxIcon.Information);

                if (MessageBox.Show ("are your sure you want to delete?") ==DialogResult.Yes)
                {

                }
                

                int id = Convert.ToInt32(MessageBoxButtons.("dgvid").Value);
